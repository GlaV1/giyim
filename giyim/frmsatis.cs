...
namespace giyim
{
    public partial class frmsatis : Form
    {
        ...
        SqlConnection baglanti = new SqlConnection("Data Source=SERHAT\\SQLEXPRESS;Initial Catalog=Stok_Takip;Integrated Security=True");
        ...
        private void frmsatis_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            if (x == DialogResult.Yes)
            {
                ...
                Environment.Exit(0);
                MessageBox.Show("powered by Serhat Ay");
